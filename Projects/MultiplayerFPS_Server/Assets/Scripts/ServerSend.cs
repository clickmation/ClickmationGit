...
public class ServerSend
{
    ...
    public static void PlayerPosition(Player _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.playerPosition))
        {
            _packet.Write(_player.id);
            _packet.Write(_player.transform.position);
            _packet.Write(_player.transform.InverseTransformDirection(_player.controller.velocity));
    ...
    public static void PlayerHealth(Player _player)
    {
        ...
        {
            _packet.Write(_player.id);
            _packet.Write(_player.playerHealth.GetHealth());
    ...
    public static void MessageToAll(int _toClient, string _msg)
    {
        using (Packet _packet = new Packet((int)ServerPackets.messageToAll))
        {
            _packet.Write(_toClient);
            _packet.Write(NetworkManager.instance.ChatIndex());
            _packet.Write(_msg);
